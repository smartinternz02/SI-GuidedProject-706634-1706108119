...
WebUI.setText(findTestObject('Object Repository/Page_Amazon Sign In/input_email'), 'charangoudambala646@gmail.com')

WebUI.click(findTestObject('Object Repository/Page_Amazon Sign In/inputcontinue'))

WebUI.setText(findTestObject('Object Repository/Page_Amazon Sign In/input_password'), 'charan@26')
